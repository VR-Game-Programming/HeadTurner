...
The remaining .csv files are the raw data files, which contain the data we used for analysis. They record our head positions over different time periods using various apps, and the app name is the file name. Please ensure your file names correspond to the appropriate app names if you want to use your raw data files as references to utilize the R code in Plan 4(Real).R to create your plots.
